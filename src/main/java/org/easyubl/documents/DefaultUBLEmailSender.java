...
public class DefaultUBLEmailSender implements UBLEmailSender {
    ...
    @Override
    public SendEventModel send(CompanyModel organization, DocumentModel document, String email, DestinyType destinyType) throws ModelInsuficientData, SendEventException {
