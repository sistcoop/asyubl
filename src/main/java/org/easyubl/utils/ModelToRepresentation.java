...
public class ModelToRepresentation {
    ...
    public OrganizationRepresentation toRepresentation(CompanyModel organization, boolean internal) {
        /**
         * General information
         */
    ...
    public OrganizationEventsConfigRepresentation toEventsConfigReprensetation(CompanyModel organization) {
