...
| secured-wf-http
| secured-wf-http-myproject.LOCAL_OPENSHIFT_HOSTNAME
|
| secured-wf-http
| <all>
|
...
You can interact with the booster using the form at the secured endpoint URL and the link:http://appdev.openshift.io/docs/wf-swarm-runtime.html#sso-users[provided users].
